...
class DiseasesControllerTest < ActionController::TestCase
  ...
  test "should create disease" do
    assert_difference('Disease.count') do
      post :create, disease: { depression: @disease.depression, schizophrenia: @disease.schizophrenia, social_anxiety_disorder: @disease.social_anxiety_disorder, user_id: @disease.user_id }
    end
  ...
  test "should update disease" do
    patch :update, id: @disease, disease: { depression: @disease.depression, schizophrenia: @disease.schizophrenia, social_anxiety_disorder: @disease.social_anxiety_disorder, user_id: @disease.user_id }
    assert_redirected_to disease_path(assigns(:disease))
  end
